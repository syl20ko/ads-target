          ...
          return {
            ...
            "Ratio achat/panier":
              articlesAjoutesAuPanier > 0
                ? ((articlesAchetes / articlesAjoutesAuPanier) * 100).toFixed(
                    2
                  ) 
                : "0",
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <div className="text-center mb-4">
              ...
              <hr />
              <p>À partir de vos données extraites de <strong>Google Analytics 4</strong> e-commerce avancé, <strong>Ads Target</strong> va automatiquement mettre en lumière les actions à mener pour améliorer vos ventes.</p>
